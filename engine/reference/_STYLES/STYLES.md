...
>
> **Фасетная система (уровень 1):** каждый стиль ниже = комбинация значений по 9 осям. Словарь осей и разложение всех 38 стилей по осям — в памятке `knowledge/axes-cheatsheet.md`.
