...
export const STYLES = {
  ...
  premium: {
    ...
    // 15.08.2026: снято с true. На витрине 14.08 титр выходил ДВАЖДЫ одновременно —
  ...
  'sticker-painted': {
    ...
    // 15.08.2026: снято с true. Единственный БРАК витрины 14.08 был здесь — на стикерах
