 ...
 *
 * ⚠ РАСХОЖДЕНИЕ, ЗНАЕМ (01.08.2026). Боевая публикация 30.07 дала другие числа:
 * низ 430, верх 200, справа 150 — они и стоят в qa-frames.mjs и в оверлее обычного
 * монтажа. Здесь осталось 250, и это НЕ описка: safeBottomY участвует в расчёте
 * capCenterY (ниже), то есть двигает плашку субтитров. Менять его — значит менять
 * проверенную раскладку, на которой замерен нулевой дрейф субтитров за 39 секунд.
 * Правка требует прогона и проверки на телефоне, а не замены числа. До тех пор:
 * в горизонтальном сценарии safe-zone проверять глазами особенно внимательно.
 *
